...
@section('title', 'BeautyCenter - faq List')
            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <div class="dropdown">
                            <a class="btn btn-outline-primary" href="{{route('admin.faq.create')}}" role="button" >Add faq</a>
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><a href={{route('admin.faq.edit',['id'=>$rs->id ])}} class="btn btn-danger" >Edit</td>
                        <td><a href={{route('admin.faq.destroy',['id'=>$rs->id ])}} class="btn btn-success" >Delete </a> </td>
